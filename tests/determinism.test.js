 ...
 *
 * 更新紀錄：
 * - 2026-09-06（第二次）調高能力點倍率至 3.4 讓奪冠率達到約 25%。
 *   實測發現玩家到 2028 年時教頭平均能力只從 22 練到 35.6，而上限平均 64.8 ——
 *   四年養成在數值上幾乎沒發生。拉點數比拉 coachQuality 好：
 *   後者到 30 時滿能力教頭對日本勝率就 90%，後期沒有張力。
...
const GOLDEN = [
  {
    ...
    ending: 'olympic_medal',
    path: '第 31 屆:亞軍 | 第六屆世界棒:亞軍 | 愛知名古屋亞:金牌 | WBSC 世:亞軍 | 洛杉磯奧運棒:銀牌',
    prestige: 100,
    approval: 100,
  },
  {
    ...
    path: '第 31 屆:亞軍 | 第六屆世界棒:亞軍 | 愛知名古屋亞:銀牌 | WBSC 世:冠軍 | 洛杉磯奧運棒:第 4 名',
    prestige: 100,
    approval: 100,
  },
  {
    ...
    ending: 'olympic_gold',
    path: '第 31 屆:亞軍 | 第六屆世界棒:八強 | 愛知名古屋亞:金牌 | WBSC 世:第 4 名 | 洛杉磯奧運棒:金牌',
    prestige: 100,
    approval: 100,
  },
];
